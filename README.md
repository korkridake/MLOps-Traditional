...
- [Practical MLOps with GitHub Actions (Classical ML)](#practical-mlops-with-github-actions-classical-ml)
  ...
  - [How is MLOps different from DevOps?](#how-is-mlops-different-from-devops)
  - [What are the key challenges we wish to solve with MLOps?](#what-are-the-key-challenges-we-wish-to-solve-with-mlops)
...
With Azure ML + GitHub Actions you can effectively and cohesively manage your datasets, experiments, models, and ML-infused applications.
